...
class StatusModule extends ReactContextBaseJavaModule implements LifecycleEventListener, ConnectorHandler {
    ...
    private void doStartNode(final String jsonConfigString) {
        ...
        try {
            ...
            String res = Status.startNode(updatedJsonConfigString);
    ...
    public void login(final String address, final String password, final Callback callback) {
        ...
        Runnable r = new Runnable() {
            @Override
            public void run() {
                String result = Status.login(address, password);
    ...
    public void createAccount(final String password, final Callback callback) {
        ...
        Runnable r = new Runnable() {
            @Override
            public void run() {
                String res = Status.createAccount(password);
    ...
    public void notifyUsers(final String message, final String payloadJSON, final String tokensJSON, final Callback callback) {
        ...
        Runnable r = new Runnable() {
                @Override
                public void run() {
                    String res = Status.notifyUsers(message, payloadJSON, tokensJSON);
    ...
    public void addPeer(final String enode, final Callback callback) {
        ...
        Runnable r = new Runnable() {
                @Override
                public void run() {
                    String res = Status.addPeer(enode);
    ...
    public void recoverAccount(final String passphrase, final String password, final Callback callback) {
        ...
        Runnable r = new Runnable() {
            @Override
            public void run() {
                String res = Status.recoverAccount(password, passphrase);
    ...
    public void sendTransaction(final String txArgsJSON, final String password, final Callback callback) {
        ...
        Runnable r = new Runnable() {
            @Override
            public void run() {
                String res = Status.sendTransaction(txArgsJSON, password);
                callback.invoke(res);
            }
        };
    ...
    public void signMessage(final String rpcParams, final Callback callback) {
        ...
        Runnable r = new Runnable() {
            @Override
            public void run() {
                String res = Status.signMessage(rpcParams);
                callback.invoke(res);
            }
        };
    ...
    public void callRPC(final String payload, final Callback callback) {
        Runnable r = new Runnable() {
            @Override
            public void run() {
                String res = Status.callRPC(payload);
                callback.invoke(res);
            }
        };
    ...
    public void callPrivateRPC(final String payload, final Callback callback) {
        Runnable r = new Runnable() {
            @Override
            public void run() {
                String res = Status.callPrivateRPC(payload);
                callback.invoke(res);
            }
        };
  ...
  public void extractGroupMembershipSignatures(final String signaturePairs, final Callback callback) {
    ...
    Runnable r = new Runnable() {
      @Override
      public void run() {
        String result = Status.extractGroupMembershipSignatures(signaturePairs);
  ...
  public void signGroupMembership(final String content, final Callback callback) {
    ...
    Runnable r = new Runnable() {
      @Override
      public void run() {
        String result = Status.signGroupMembership(content);
  ...
  public void enableInstallation(final String installationId, final Callback callback) {
    ...
    Runnable r = new Runnable() {
      @Override
      public void run() {
        String result = Status.enableInstallation(installationId);
  ...
  public void disableInstallation(final String installationId, final Callback callback) {
    ...
    Runnable r = new Runnable() {
      @Override
      public void run() {
        String result = Status.disableInstallation(installationId);
